...
import { EditorPoiLibrary } from "./layout/poi-library";
...
export class EditorLayout extends Component<IEditorLayoutProps> {
  ...
  public poiLibrary!: EditorPoiLibrary;
  ...
  private _components: Record<string, ReactNode> = {
    ...
    "poi-library": <EditorPoiLibrary editor={this.props.editor} ref={(r) => { this.poiLibrary = r! }} />,
   ...
   */
  public selectTab(tabId: "graph" | "preview" | "assets-browser" | "poi-library" | "console" | "inspector" | (string & {})): void {
