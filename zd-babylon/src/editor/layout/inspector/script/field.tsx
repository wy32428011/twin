						...
						onChange={(v) => {
							...
							registerUndoRedo({
								...
								action: () => {
									...
									props.editor.layout.preview.editorPlay.hotReloadScriptForNotPlaying(props.script.key, false, props.object);
								},
	...
	return (
		<div className="flex flex-col gap-2 bg-muted-foreground/35 dark:bg-muted-foreground/5 rounded-lg px-5 pb-2.5">
			<div className="flex gap-[10px]">
				<SiTypescript size="80px" className="opacity-100 transition-all duration-300 ease-in-out" />
				...
				<div className="flex flex-col gap-1 w-full py-2.5">
					<div className="flex items-center">
						...
						>
							{props.script.key} {exists !== false ? "" : "（未找到）"}
						</div>
