...
import { AbstractMesh, InstancedMesh, Material, Mesh, Node, Observer } from "babylonjs";
...
export class EditorMeshInspector extends Component<IEditorInspectorImplementationProps<AbstractMesh>, IEditorMeshInspectorState> {
      ...
      <>
        <EditorInspectorSectionField title="属性">
          ...
          {this.props.object.geometry && (
            <>
              <EditorInspectorSwitchField label="可选" object={this.props.object} property="isPickable" />
        ...
        {this.props.editor.layout.preview.scene.lights.length > 0 && this.props.object.geometry && (
          <EditorInspectorSectionField title="阴影">
            ...
            />
            <EditorInspectorSwitchField label="接收阴影" object={this.props.object} property="receiveShadows" />
          </EditorInspectorSectionField>
        )}
  ...
  private _handleTransformsUpdated(): void {
   ...
   _getLODsComponent(): ReactNode {
    ...
    return (
      <EditorInspectorSectionField title="LOD">
        <EditorInspectorNumberField
          object={o}
          property="distance"
          label="线性距离"
          tooltip="定义各级 LOD 之间的间距"
          step={1}
          noUndoRedo
  ...
  _handleAddMaterial(command: ICommandPaletteType): void {
