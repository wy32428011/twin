...
export class EditorAnimation extends Component<IEditorAnimationProps, IEditorAnimationState> {
	...
	public render(): ReactNode {
		if (!this.props.editor.state.enableExperimentalFeatures) {
			return <div className="flex justify-center items-center w-full h-full font-semibold text-3xl">即将推出</div>;
		}
		...
		return (
			<div className="flex flex-col min-w-full h-full">
				...
				<div className="flex w-full h-10">
					<div className="flex justify-center items-center font-semibold w-96 h-full bg-secondary">轨道</div>

					<div className="w-1 h-full bg-primary-foreground" />

					<div className="flex justify-center items-center font-semibold w-full h-full bg-secondary">时间轴</div>
				</div>
